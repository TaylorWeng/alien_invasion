import sys
from time import sleep # Python标准模块time中导入函数 sleep（），以便飞船被外星人庄到后让游戏暂停片刻。
...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # 设置游戏的屏幕 - Taylor - 下面这个显示屏幕的程序，会导致ship消失？？没有搞明白。。。
        ...
        self.ship = Ship(self)
        self.bullets = pygame.sprite.Group() # 这个pygame里的东东还没有看明白？？？？？？？？
